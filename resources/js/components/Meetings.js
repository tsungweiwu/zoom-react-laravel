...
class Meetings extends Component {
    ...
    render() {
        ...
        const meetings = this.props && this.props.meetings.length > 0 ?
                        ...
                        <Card.Body>
                            ...
                            <Button onClick={() => handleOpen(meeting.id)} className="buttonDelete" variant="danger">X</Button>
                                <Modal show={this.state.showDelete} onHide={handleClose}>
                                    ...
                                    <Modal.Body>You're about delete a Zoom meeting. Are you sure?</Modal.Body>
                                    <Modal.Footer>
                            ...
                            <Card.Subtitle className="mb-2 text-muted">{getDate(meeting.start_time)}</Card.Subtitle>
                            <Card.Text>
                                Duration: {meeting.duration/60} Hours
                            </Card.Text>
                            <Card.Text>
